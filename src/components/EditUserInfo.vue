<template>
  <el-dialog :visible.sync="visible" width="900px" append-to-body>
    <template #title>
      Edit Customer User (
      <span style="color: red">English input only</span>
      )
    </template>
    <el-form :model="form" :inline="false" size="small" label-width="140px">
      <el-row>
        <el-col :sm="11" :xs="24">
          <!-- <el-form-item label="Account" prop="accountEmail">
            {{ form.accountEmail }}
          </el-form-item> -->
          <el-form-item label="Account" prop="accountEmail">
            <el-input v-model="form.accountEmail"></el-input>
          </el-form-item>
